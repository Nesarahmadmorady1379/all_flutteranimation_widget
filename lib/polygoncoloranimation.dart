...
class _PoloygonalState extends State<Poloygonal> with TickerProviderStateMixin {
  ...
  late AnimationController _coloranimationcontrolar;
  ...
  void initState() {
    ...
    _coloranimationcontrolar =
        AnimationController(vsync: this, duration: Duration(seconds: 3));
    _coloranimation = ColorTween(begin: getrandomcolor(), end: getrandomcolor())
        .chain(CurveTween(curve: Curves.easeInOut))
        .animate(_coloranimationcontrolar);
  }
  ...
  void didChangeDependencies() {
    ...
    _coloranimationcontrolar.repeat(reverse: true);
  ...
  void dispose() {
    ...
    _coloranimationcontrolar.dispose();
    super.dispose();
  }
...
getrandomcolor() {
  Random r = Random();
  var randomecolor = Color.fromARGB(
